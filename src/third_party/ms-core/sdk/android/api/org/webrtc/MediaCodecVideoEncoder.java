...
public class MediaCodecVideoEncoder {
   ...
   * the old behavior.
   */
  // Unused, remove dependency on VideoEncoderFactory
  ...
  private static MediaCodecProperties[] vp8HwList() {
    ...
    // Unused, remove dependency on PeerConnectionFactory
  ...
  private static final MediaCodecProperties exynosH264HwProperties = new MediaCodecProperties(
      ...
      "OMX.Exynos.", Build.VERSION_CODES.KITKAT, BitrateAdjustmentType.NO_ADJUSTMENT);
  ...
  private static final MediaCodecProperties[] h264HwList() {
    ...
    // }
    supported_codecs.add(mediatekH264HwProperties);
    supported_codecs.add(hisiH264HwProperties);
    supported_codecs.add(imgH264HwProperties);
    return supported_codecs.toArray(new MediaCodecProperties[supported_codecs.size()]);
  }
  ...
  // 调整颜色空间优先级，解决华为荣耀6使用YUV420P crash的问题
